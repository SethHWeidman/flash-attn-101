...
// set_params_fprop
template <typename T>
void set_params_fprop(Flash_fwd_params &params, const size_t b, const size_t seqlen_q,
                      const size_t seqlen_k, const size_t h, const size_t d, const T *q, const T *k,
                      const T *v, T *out, float softmax_scale, bool is_causal) {
  // reset params
  params = {};
...
// mha_fwd
template <typename T>
void mha_fwd(const T *q, const T *k, const T *v, T *o, unsigned int batch_size,
  ...
  set_params_fprop(params, batch_size, seqlen_q, seqlen_k, num_heads, head_dim, q, k, v, o,
...
template void mha_fwd<__half>(const __half *q, const __half *k, const __half *v, __half *o,
                              unsigned int batch_size, unsigned int num_heads, unsigned int seq_len,
